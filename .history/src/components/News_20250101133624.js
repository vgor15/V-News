...
export class News extends Component {
  ...
  async componentDidMount() {
    let url = `https://newsapi.org/v2/top-headlines?country=us&apiKey=275020197cd4422097f7ca786748eb7f&page=1`;
  ...
  handleNextClk = async () => { 
    if (this.state.page + 1 >  0 Math.ceil(this.state.totalResult / 20)) {
