        ...
        <div className="responsive-container-block Container">
          <div className="responsive-container-block leftSide">
            ...
            <p className="text-blk subHeading">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima incidunt quasi nam perspiciatis optio animi vero necessitatibus illo esse, rerum nulla, excepturi reiciendis officia numquam, culpa expedita? Nesciunt, eveniet tenetur!
              Velit perferendis pariatur, distinctio, repellendus nesciunt asperiores id earum dolorum cumque architecto eum ab corporis sed, autem possimus quae. Culpa quis saepe et exercitationem reiciendis eveniet ducimus voluptates cupiditate temporibus.
            </p>
          </div>
