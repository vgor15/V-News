...
export class News extends Component {
  ...
  async componentDidMount() {
    let url = `https://newsapi.org/v2/top-headlines?country=us&apiKey=275020197cd4422097f7ca786748eb7f&page=1&pageSize=${this.props.pageSize}`;
    ...
    return (
      <div className="container my-5">
        ...
        <div className="d-flex justify-content-between">
          ...
          <button
            disabled={this.state.page + 1 > Math.ceil(this.state.totalResult / this.props.page)}
            className="btn btn-danger"
