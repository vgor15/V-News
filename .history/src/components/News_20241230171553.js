...
export class News extends Component {
  articles = [
    ...
    },
    {
      ...
      urlToImage:
        "https://images.jpost.com/image/upload/f_auto,fl_lossy/c_fill,g_faces:center,h_407,w_690/641295",
      publishedAt: "2024-12-30T07:47:22Z",
      content:
        "Gal Gadot was diagnosed “with a massive blood clot in [her] brain” during the eighth month of her pregnancy last February and nearly died, she wrote in an Instagram post on Sunday. Gadot said that a… [+2092 chars]",
    },
    {
      source: {
        id: "abc-news",
      ...
      content:
        "NEW YORK -- Linda Lavin, a Tony Award-winning stage actress who became a working class icon as a paper-hat wearing waitress on the TV sitcom Alice, has died. She was 87. Lavin died in Los Angeles on… [+4413 chars]",
    },
    {
      source: {
        id: "reuters",
    ...
    },
    {
      ...
      description:
        "Daniels threw for 227 yards and three touchdowns, including the game-winner to Zach Ertz, and ran for 127 yards.",
      ...
      content:
        "Jayden Daniels did it again, leading another comeback to get the Commanders into the postseason for the first time since 2020. The rookie quarterback directed a 12-play, 75-yard touchdown drive in o…",
    },
  ];
