    ...
    return (
      <div className="container my-5 ">
        ...
        <div className="row">
          ...
          <div className="col-md-4">
            <NewsItem title="title here " description="description here " imgUrl ="https://tse4.mm.bing.net/th?id=OIP.hXvH7TlMzwXDmf5TyxHhOwHaGM&pid=Api"/>
          </div>
          <div className="col-md-4">
            <NewsItem title="title here " description="description here " imgUrl =""/>
          </div>
        </div>
      </div>
    );
